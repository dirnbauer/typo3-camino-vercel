...
not make uploaded files durable. TYPO3 editor uploads still need an external FAL
storage backend such as S3-compatible storage, Cloudflare R2, or a Vercel Blob
FAL adapter.
